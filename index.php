        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex align-items-center justify-content-center">
                        <div class="p-5" style="width: 100%; max-width: 900px;">
                            <h5 class="text-primary text-uppercase mb-md-3">IFM Services</h5>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex align-items-center justify-content-center">
                        <div class="p-5" style="width: 100%; max-width: 900px;">
                            <h5 class="text-primary text-uppercase mb-md-3">Office Sanitization</h5>
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="d-flex flex-column align-items-center justify-content-center bg-about rounded h-100 py-5 px-3">
                        ...
                        <h1 class="display-2 text-white mb-2" data-toggle="counter-up">05</h1>
                        <h2 class="text-white m-0">Years Experience</h2>
                    </div>
                </div>
                <div class="col-lg-7 pt-5 pb-lg-5">
                    <h6 class="text-secondary font-weight-semi-bold text-uppercase mb-3">About Us</h6>
                    <h1 class="mb-4 section-title">We Provide The Best Cleaning Services</h1>
                    <h5 class="text-muted font-weight-normal mb-3">Welcome to Workforce Enterprises, your trusted partner in creating pristine and safe work environments. With a dedicated focus on office sanitization, technical services, and workplace support, we are committed to elevating your workspace standards. Our highly trained team employs cutting-edge technology and industry-leading practices to ensure the utmost cleanliness and hygiene. From thorough office sanitization to expert technical support, we tailor our services to meet your specific needs. At Workforce Enterprises, we understand the importance of a clean and efficient workplace, contributing to a healthier and more productive work environment. Partner with us for excellence in cleaning, technical expertise, and comprehensive workplace support. Your success starts with a cleaner, safer workplace – choose Workforce Enterprises today.</p>
                </div>
            </div>
        </div>
    </div>
